    ...
    <div class="my-4">
        ...
        <div class="row p-1" style="background: black; border: white solid 1px;border-radius: 6px;margin:4px 0px">
            <div class="col-6">
                ...
                <input class="form-check-input" type="radio" name="maintenance" id="InputMaintenanceFalse" value=0 {{ $maintenance==0 ? "checked" : "" }}>
            </div>

            <div class="col-6">
                <label for="InputMaintenanceTrue">Manutenção</label>
                <input class="form-check-input" type="radio" name="maintenance" id="InputMaintenanceTrue" value=1 {{ $maintenance==1 ? "checked" : "" }}>
            </div>
        </div>
    </div>
